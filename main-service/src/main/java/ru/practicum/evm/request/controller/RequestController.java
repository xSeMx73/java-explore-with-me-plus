...
public class RequestController {
    ...
    @GetMapping
    Collection<RequestDto> get(@PathVariable final long userId) {
    ...
    RequestDto save(@PathVariable final long userId, @RequestParam long eventId) {
    ...
    RequestDto delete(@PathVariable final long userId, @PathVariable long requestId) {
